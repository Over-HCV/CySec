...
import { countKind, hasRepo, joined, REFS_BIB, repoFile } from './fixtures'

const bib = repoFile(REFS_BIB)

describe.skipIf(!hasRepo)('parseBib sobre refs.bib', () => {
...
describe.skipIf(!hasRepo)('parseBib en casos límite', () => {
