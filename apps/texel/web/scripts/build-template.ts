...
/**
 * Dónde buscar `latex/` en disco. `TEXEL_LATEX_DIR` manda: si se pasa, se usa
 * esa y solo esa, lo que además permite forzar el camino de «no hay disco». Si
 * no, se prueban los dos sitios donde suele estar: un clon de CySec al lado de
 * este repo, y el monorepo de antes de la separación.
 */
const DISK_CANDIDATES = process.env.TEXEL_LATEX_DIR
