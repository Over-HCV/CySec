...
% Si existe img/archivo.png lo incluye como figura con su caption; si no,
...
\newcommand{\captura}[2]{%
  ...
  \begin{figure}[htbp]
    ...
    \IfFileExists{img/#1}{%
      ...
      \PackageWarning{cysec}{Captura pendiente: img/#1}%
      \begin{tcolorbox}[enhanced, sharp corners, colback=gray!4,
        ...
        {\footnotesize\color{gray!45!black}%
          \cysec@lbl{guardar como}{save as} \texttt{img/#1}}%
      \end{tcolorbox}%
    }
    \caption{#2}%
